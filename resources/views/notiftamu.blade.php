...
<body>
    ...
    <div class="container">
        ...
        <ul>
            <li>Berikut Kami Kirimkan Kode Surat Pengajuan anda, Silahkan cek status surat anda di Website Buku Tamu PT PLN MCTN </li>
            <center><strong><p>{{$surat2->kode_unik}}</p></strong></center>
        </ul>
