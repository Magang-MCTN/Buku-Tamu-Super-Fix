            ...
            <div class="col-sm-12">
                <div class="home-tab">
                    <div class="row">
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col">
                            <a href="/historysecurity" class="text-decoration-none">
                                <div class="card mb-2">
                                    <div class="card-body d-flex align-self-center">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                @foreach ($suratToApprove as $data)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('security.surat2.history', ['id' => $data->id_surat_2_duri]) }}"
                                            ...
                                            <a href="/historysecurity" >Lihat Selengkapnya</a></td>
                                            </div>
