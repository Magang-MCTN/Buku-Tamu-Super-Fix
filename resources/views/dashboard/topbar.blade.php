    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
      <ul class="navbar-nav">
        <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
          <h1 class="welcome-text">Selamat Datang <span class="text-white fw-bold">{{ auth()->user()->name }}</span></h1>
          <h3 class="welcome-sub-text">Anda Login sebagai <span class="text-white fw-bold"> @if(Auth::check())
            {{ Auth::user()->role->keterangan_role }}
        @endif</span></h3>
        </li>
      </ul>
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
            <div class="dropdown-header text-center mx-4">
            ...
            <a class="dropdown-item" href="/profile/{{ auth()->user()->id}}"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile</a>
