                        ...
                        <div class="col">
                          <div class="row form-group">
                              <div class="col me-2" style="align-items: center;">
                                  <form method="get" action="{{ route('phr.history.filter') }}">
                                  ...
                                  <form method="get" action="{{ route('phr.history.filter') }}">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn mb-4 ms-1" type="submit" style="background-color: #097b96; color: white">Filter</button>
                                        </div>
                                    </div>
                                  </form>
                              </div> --}}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              @elseif($data->statusSurat->nama_status_surat == 'Ditolak Admin' || $data->statusSurat->nama_status_surat == 'Ditolak PHR' || $data->statusSurat->nama_status_surat == 'Ditolak')
                                            ...
                                            <td>
                                                <a href="{{ route('phr.surat2.history', ['id' => $data->id_surat_2_duri]) }}"
