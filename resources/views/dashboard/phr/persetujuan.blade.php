                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="row form-group">
                                <div class="col me-2" style="align-items: center;">
                                    <form method="get" action="{{ route('phr.persetujuan.cari') }}">
                                        @csrf
                        ...
                        <div class="container">
                            <div class="card mt-2">
                                ...
                                <td>
                                    <a href="{{ route('phr.surat2.show', ['id' => $data->id_surat_2_duri]) }}" class="btn" style="background-color: #097b86; color: white">Lihat</a>
                                </td>
                            </tr>
                        @endforeach
                                        </tbody>
