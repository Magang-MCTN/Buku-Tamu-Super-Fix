...
<body>
    ...
    <div class="container">
        ...
        <ul>
            <li>Ada Pengajuan Menunggu Persetujuan Admin, Silahkan Klik dibawah ini </li>
        </ul>
        <center><a href="http://127.0.0.1:8000/admin/surat2/{{$surat2->id_surat_2_duri}}">Lihat Detail</a></center>
        <ul>
